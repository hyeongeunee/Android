...
/*
    ...
    - 재활용이라는 것은 여러 개의 액티비티에서 활용된다는 의미
...
public class MyFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        /*
            ...
            전달하고자 한다면 어떻게 해야 할까?
         */
        // MainActivity > FragmentActivity type > Context type
        // 프레그먼트 내에서 this 는 프레그먼트를 가리켜서 오류가 남 >> this 사용불가 >> getActivity 사용해야 함
        // Toast.makeText(this, "xxx", Toast.LENGTH_SHORT).show();

        // MainActivity(SubActivity) > FragmentActivity > Context > Object (상속관계)
        FragmentActivity a = getActivity();
        Context b = getActivity();
        MainActivity c = (MainActivity) getActivity();

        // 이렇게 하면 MainActivity 에서만 사용된다. >> 이렇게 의존하면 안대용 ~
        //c.sendMsg("hello~");
